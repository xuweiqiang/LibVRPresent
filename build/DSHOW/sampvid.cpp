...
const AMOVIESETUP_FILTER sudSampVid =
{
    ...
    L"Cidana Video Renderer",   // Filter name
...
{
    return new CVideoRenderer(NAME("Cidana Video Renderer"),pUnk,phr);
...
CVideoRenderer::CVideoRenderer(TCHAR *pName,
    ...
    m_ImageAllocator(this,NAME("Cidana video allocator"),phr),
