...
void mem_close_driver(DRIVER_HANDLE driver)
{
	...
	if (0 == mem_open_count)
	{
		if (mem_handle == driver)
		{
			CloseHandle(mem_handle);
		}
		else
		{
			OS_Print(1, "mempool handle mismatch error!\r\n");
		}
	}
}
...
unsigned int maeite_calc_sr(int orig_size, int scale_size)
{
	...
	sri = (uint32)scale_ratio;
	srf = (uint32) ((1 << 16) * (scale_ratio - sri)) ;
...
//
///////////////////////////////////////////////////////////////////////////////
void maeite_set_default_scf(mae_be_request_t *ite, uint32 mode)
{
	int i;
	uint32 *filter_coeffs = mode ? FIELD_FILTER_COEFFS : FRAME_FILTER_COEFFS;
...
//
///////////////////////////////////////////////////////////////////////////////
void maeite_setup_src_regs(mae_be_request_t *ite, uint32 fourcc, uint32 address, 
...
//		ite->srccfg = MAEBE_SRCCFG_IF_N(SRCCFG_IF_420);
      ite->srccfg = MAEBE_SRCCFG_IF_N(SRCCFG_IF_420) | MAEBE_SRCCFG_EF;
...
//
///////////////////////////////////////////////////////////////////////////////
int maeite_submit_frame(DRIVER_HANDLE driver, mae_be_request_t *ite, uint32 timeout, uint32 flags)
{
