...
STGLIB_API_CALL int			STGetSurfaceBufferAddress(STHDC hDC, PVOID* address);
...
STGLIB_API_CALL int			STBltVideoMapIndexed(STHDC hDC, int x0, int y0, int x1, int y1, STHVIDEOMAP pSrc, int nXSrc, int nYSrc, STROP dwRop);

STGLIB_API_CALL int			STBindVideoMapToVideoIn(STHVIDEOMAP hVideoMap);
STGLIB_API_CALL int			STUnbindVideoMapToVideoIn(STHVIDEOMAP hVideoMap);
STGLIB_API_CALL int			STSetCropVideo(STHVIDEOMAP pSrc, const int x, const int y, const int w, const int h, BOOL processOddEven);

STGLIB_API_CALL int			STBindBitmapToVideoIn(STHBITMAP hBitmap);
...
STGLIB_API_CALL int			STRenderVideoBuffer(STHDC hDC, STHBITMAP buffer, int blockW, int blockH, BOOL waitVSync, DWORD realPhyAddr, DWORD uOffset, DWORD vOffset);
STGLIB_API_CALL int			STGetVideoBufferAddress(STHDC hDC, STHBITMAP buffer, PVOID* address, PVOID* phyAddr);
STGLIB_API_CALL int			STGetVideoBufferSize(STHDC hDC, STHBITMAP buffer, int *byteSize);

STGLIB_API_CALL DWORD		STGetVideoSramBuffer(STHDC hDC,	DWORD dwSize);
STGLIB_API_CALL DWORD		STGetVideoTCMBuffer(STHDC hDC,	DWORD dwSize);
...
STGLIB_API_CALL int			STCopyDeocde2Flip(STHDC hDC, DWORD decodePhyAddr, DWORD flipVirtualAddr);

STGLIB_API_CALL int			STSetFlipAddress(STHDC hDC, DWORD yBuffer,  DWORD uOffset, DWORD vOffset, DWORD yStride);
