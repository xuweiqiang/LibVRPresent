================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : SH4_t1 Project Overview
===============================================================================

The application wizard has created this SH4_t1 application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your SH4_t1 application.
...
SH4_t1.h
    ...
    project specific headers and declares the CSH4_t1App application class.
...
SH4_t1Dlg.h, SH4_t1Dlg.cpp - the dialog
    These files contain your CSH4_t1Dlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named SH4_t1.pch and a precompiled types file named StdAfx.obj.
