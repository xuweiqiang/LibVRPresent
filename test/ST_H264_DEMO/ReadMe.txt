================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : ST_DEMO Project Overview
===============================================================================

The application wizard has created this ST_DEMO application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your ST_DEMO application.
...
ST_DEMO.h
    ...
    project specific headers and declares the CST_DEMOApp application class.
...
ST_DEMODlg.h, ST_DEMODlg.cpp - the dialog
    These files contain your CST_DEMODlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named ST_DEMO.pch and a precompiled types file named StdAfx.obj.
