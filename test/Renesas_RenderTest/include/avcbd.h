...
#define AVCBD_MAX_VPU_FRAME_NUM (32)
...
typedef struct {
	...
	unsigned long VPU_FRAME_NUM; /**< VPU_FRAME_NUM in slice_header() */
...
typedef struct {
	...
	unsigned short log2_max_VPU_FRAME_NUM; /**< modified from log2(x)-4 [4,16] */
	...
	unsigned char gaps_in_VPU_FRAME_NUM_value_allowed_flag; /**< one bit */
