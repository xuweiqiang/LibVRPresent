================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : RenderTest Project Overview
===============================================================================

The application wizard has created this RenderTest application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your RenderTest application.
...
RenderTest.h
    ...
    project specific headers and declares the CRenderTestApp application class.

RenderTest.cpp
    This is the main application source file that contains the application
    class CRenderTestApp.
...
RenderTestDoc.h, RenderTestDoc.cpp - the document
    These files contain your CRenderTestDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CRenderTestDoc::Serialize).

RenderTestView.h, RenderTestView.cpp - the view of the document
    These files contain your CRenderTestView class.
    CRenderTestView objects are used to view CRenderTestDoc objects.
...
StdAfx.h, StdAfx.cpp
    ...
    named RenderTest.pch and a precompiled types file named StdAfx.obj.
