================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : LibVrPresent_Test Project Overview
===============================================================================

The application wizard has created this LibVrPresent_Test application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your LibVrPresent_Test application.
...
LibVrPresent_Test.h
    ...
    project specific headers and declares the CLibVrPresent_TestApp application class.

LibVrPresent_Test.cpp
    This is the main application source file that contains the application
    class CLibVrPresent_TestApp.
...
LibVrPresent_TestDlg.h, LibVrPresent_TestDlg.cpp - the dialog
    These files contain your CLibVrPresent_TestDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named LibVrPresent_Test.pch and a precompiled types file named StdAfx.obj.
