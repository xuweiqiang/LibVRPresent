...
public: /* equivalent to MP4 library API */
	...
	MP4SampleId GetNextSyncSample(MP4TrackId trackId, MP4SampleId sampleId);
 ...
 public:
	...
	int Peek(MP4TrackId track1, MP4SampleId sample1, MP4TrackId track2, MP4SampleId sample2);
