================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : TITIANII_OSD_TEST Project Overview
===============================================================================

The application wizard has created this TITIANII_OSD_TEST application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your TITIANII_OSD_TEST application.

TITIANII_OSD_TEST.vcproj
...
TITIANII_OSD_TEST.h
    ...
    project specific headers and declares the CTITIANII_OSD_TESTApp application class.

TITIANII_OSD_TEST.cpp
    This is the main application source file that contains the application
    class CTITIANII_OSD_TESTApp.

TITIANII_OSD_TEST.rc
...
TITIANII_OSD_TESTDlg.h, TITIANII_OSD_TESTDlg.cpp - the dialog
    These files contain your CTITIANII_OSD_TESTDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named TITIANII_OSD_TEST.pch and a precompiled types file named StdAfx.obj.
