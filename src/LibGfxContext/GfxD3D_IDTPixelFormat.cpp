// GfxD3D_IDTPixelFormat.cpp: implementation of the GfxD3D_IDTPixelFormat class.
...
GfxD3D_IDTPixelFormat::GfxD3D_IDTPixelFormat()
{
}
...
DWORD GfxD3D_IDTPixelFormat::GetRBitLoc(D3DFORMAT format)
{
	return GetShiftValue(GetRBitMask(format));
}

DWORD GfxD3D_IDTPixelFormat::GetGBitLoc(D3DFORMAT format)
{
	return GetShiftValue(GetGBitMask(format));
}

DWORD GfxD3D_IDTPixelFormat::GetBBitLoc(D3DFORMAT format)
{
	return GetShiftValue(GetBBitMask(format));
}

DWORD GfxD3D_IDTPixelFormat::GetABitLoc(D3DFORMAT format)
{
	return GetShiftValue(GetABitMask(format));
}

DWORD GfxD3D_IDTPixelFormat::GetBitDept(D3DFORMAT format)
{
...
HRESULT GfxD3D_IDTPixelFormat::GetDTPixelFormat(D3DFORMAT format, DT_PIXELFMT *dtpixelfmt)
{
...
DWORD GfxD3D_IDTPixelFormat::GetABitMask(D3DFORMAT format)
{
...
DWORD GfxD3D_IDTPixelFormat::GetRBitMask(D3DFORMAT format)
{
...
DWORD GfxD3D_IDTPixelFormat::GetGBitMask(D3DFORMAT format)
{
...
DWORD GfxD3D_IDTPixelFormat::GetBBitMask(D3DFORMAT format)
{
...
DWORD GfxD3D_IDTPixelFormat::GetShiftValue(DWORD dmask)
{
	DWORD dwShift = 0;
...
DWORD GfxD3D_IDTPixelFormat::GetAMaxVal(D3DFORMAT format)
{
...
DWORD GfxD3D_IDTPixelFormat::GetRMaxVal(D3DFORMAT format)
{
...
DWORD GfxD3D_IDTPixelFormat::GetGMaxVal(D3DFORMAT format)
{
...
DWORD GfxD3D_IDTPixelFormat::GetBMaxVal(D3DFORMAT format)
{
	if (format == D3DFMT_R5G6B5) return 31;
	if (format == D3DFMT_A8R8G8B8) return 255;
	if (format == D3DFMT_R8G8B8) return 255;
