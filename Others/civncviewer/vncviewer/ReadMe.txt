================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : vncviewer Project Overview
===============================================================================

The application wizard has created this vncviewer application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your vncviewer application.
...
vncviewer.h
    ...
    project specific headers and declares the CVncViewerApp application class.
...
vncviewerDlg.h, vncviewerDlg.cpp - the dialog
    These files contain your CVncViewerDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named vncviewer.pch and a precompiled types file named StdAfx.obj.
